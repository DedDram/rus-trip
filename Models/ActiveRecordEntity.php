...
abstract class ActiveRecordEntity
{
     ...
     * @return static[]
     */
    public static function findAllObjectId(string $objectName, int $objectId, string $sort = ''): array
    {
        $db  = Db::getInstance();
        return $db->query('SELECT * FROM `' . static::getTableName() . '` WHERE '.$objectName.' = '.$objectId .' '.$sort.';', [], static::class);
    }
