<footer>
    <div class="w728 opac">
        ...
        <div class="right">
            ...
            на info{собака}rus-trip.ru и мы его сразу удалим.<!-- /noindex -->
            &copy; 2008 - <?php echo date('Y'); ?><br/>
        </div>
    </div>
    <div class="center"><!--module.db:footer-bottom--></div>
</footer>
<script type="text/javascript"> (function (m, e, t, r, i, k, a) {
    ...
    ym(11510731, "init", {clickmap: true, trackLinks: true, accurateTrackBounce: true}); </script>
<noscript>
