...
$this->countComments = sizeof($comments['comments']);
...
?>
<?php $this->modulePosition = floor($this->countComments / 2); ?>
        ...
        <div class="scomments-items" itemscope itemtype="https://schema.org/Review">
            ...
            <div class="scomments-all">
                <?php foreach ($this->items as $item): ?>
                    ...
                    ?>
                    <?php if ($this->countComments > 10 && $this->modulePosition == $i): ?>
