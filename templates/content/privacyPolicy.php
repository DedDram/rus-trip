        ...
        <div id="main">
            <div id="aCenter">
                <div itemprop="articleBody">
                    ...
                    <p>Our website rus-trip.ru may contain links to other websites, which are not under our control. We are not responsible for the content of these websites. We recommend you familiarize yourself with the privacy policy of every website that you visit, if such policy exists.</p>
                    <p>Changes to the privacy policy</p>
                    <p>From time to time, our website rus-trip.ru may update our privacy policy. We inform about any changes to the privacy policy, placed on this webpage. We are monitoring any changes in legislation, which is related to personal data in European Union and US. If you have entered any of your personal data on our website, we will inform you about the changes in our privacy policy. If your personal data, and more specifically, your contact information was entered incorrectly, we will not be able to contact you.</p>
                    <p>Feedback and final clauses</p>
                    <p>You can contact the administration of rus-trip.ru regarding any questions related to privacy policy on: info@rus-trip.ru, or by filling a contact form specified in a corresponding section of this website. If you do not agree with this privacy policy, you cannot use the services of rus-trip.ru. In this case you should avoid visiting our website.</p> </div>
            </div>
        </div>
    </div>
